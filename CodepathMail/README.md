...
- [X] (4 pts) **User can scroll through a list of 10 emails.**
    - Each email contains the following information:
        ...
        - Email title
        - Email summary
    - ![GIF showing the basic email list display]() <!-- Replace this link with your actual image/GIF link -->
...
- [X] (3 pts) **User can press a 'Load More' button to see the next 5 emails displayed.**
    - ![GIF showing the 'Load More' button in action]() <!-- Replace this link with your actual image/GIF link -->

- [X] (3 pts) **Each email displays additional information:**
    - Picture of the sender
    - Email sent date
    - Bolded information if the email is unread
    - ![GIF showing additional email information]() <!-- Replace this link with your actual image/GIF link -->
